                        ...
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- ">
                            <ul class="kt-menu__nav ">
                                ...
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
                                        href="<?= site_url('guru/data_nilai') ?>" class="kt-menu__link "><span
                                            ...
                                            <form action="<?= site_url('guru/nilai_edit') ?>" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text" name="nama_mapel" class="form-control" value="<?= $detail['nama_mapel'] ?>" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <select name="semester" class="form-control" required>
                                                            <?php for($i = 1; $i <= 6; $i++): ?>
                                                                <option value="<?= $i ?>" <?= ($detail['semester'] == $i) ? 'selected' : '' ?>>Semester <?= $i ?></option>
                                                            <?php endfor; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="number" name="nilai" class="form-control" min="0" max="100" value="<?= $detail['nilai'] ?>" required>
                                                    </div>
                                                </div>
