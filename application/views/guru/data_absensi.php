                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true">
                                            <a href="<?= site_url('guru/data_absensi') ?>" class="kt-menu__link ">
                                    ...
                                    <div class="kt-portlet__head kt-portlet__head--lg">
                                        ...
                                        <div class="kt-portlet__head-toolbar">
                                            <div class="kt-portlet__head-wrapper">
                                                <button class="btn btn-brand btn-icon-sm" data-toggle="collapse"
                                                    data-target="#formTambah">
                                                    <i class="flaticon2-plus"></i> Tambah Data Absensi
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="collapse mb-4" id="formTambah">
                                            <div class="card card-body bg-light">
                                                ...
                                                <form action="<?= site_url('guru/tambah_absensi') ?>" method="POST">
                                                    ...
                                                    <button type="button" class="btn btn-secondary"
                                                        data-toggle="collapse" data-target="#formTambah">Batal</button>
                                                </form>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                <?php if (!empty($absensi)): ?>
                                                    <?php foreach ($absensi as $a): ?>
                                                        <tr>
                                                            <td><?= $a->id ?></td>
                                                            <td><?= $a->nama ?? '<em class="text-muted">Tidak Ditemukan</em>' ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                <span
                                                                    class="kt-badge kt-badge--<?= $badge_color ?> kt-badge--inline kt-badge--pill">
                                                                    <?= strtoupper($a->status) ?>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <a href="<?= site_url('guru/update_absensi/' . $a->id) ?>"
                                                                    class="btn btn-info btn-sm">Edit ✎</a>
                                                                <a href="<?= site_url('guru/delete_absensi/' . $a->id) ?>"
