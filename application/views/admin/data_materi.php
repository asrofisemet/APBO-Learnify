...
<body>
                    ...
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            ...
                            <p class="card-text"> After I ran into Helen at a restaurant, I realized she was just office
                                pretty drop-dead date put in in a deck for our standup today. Who's responsible for the
                                ask for this request? who's responsible for the ask for this request? but moving the
                                goalposts gain traction.</p>
                            <a href="<?= site_url('admin/tambah_materi') ?>" class="btn btn-success">Tambah
                                Data Materi ⭢</a>
                        </div>
                    </div>
                    <div class="row">
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div> <a href="https://github.com/syauqi">Syauqi Zaidan Khairan
                Khalaf</a>
        </div>
    </footer>
    <!-- End Footer -->
