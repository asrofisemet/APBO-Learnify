...
<head>
    ...
    <title>Data Nilai - Learnify</title>
...
<body>
        ...
        <div class="main-wrapper">
                        ...
                        <div>
                            <a href="<?= site_url('admin') ?>"
                                ...
                                class="text-success text-center"><i style="font-size: 30px;"
                                    class="fas fa-graduation-cap"></i> | Learnify <sup>3</sup></a>
                        </div>
                    </div>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Nilai Siswa</h2>
                            <hr>
                            <p class="card-text">Tambahkan data nilai siswa untuk mencatat pencapaian akademik mereka.
                            </p>
                            ...
                            <div class="collapse mt-3" id="formTambah">
                                <div class="card card-body bg-light">
                                    <h5 class="font-weight-bold mb-3">Form Tambah Nilai</h5>
                                    <form action="<?= site_url('admin/tambah_nilai') ?>" method="POST">
                                            ...
                                            <?php if (!empty($nilai)): ?>
                                                <?php foreach ($nilai as $n): ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?= $n->nama ?? '<em class="text-muted">Tidak Ditemukan</em>' ?>
                                                        </td>
                                                        <td>
                                                            <?= $n->nama_mapel ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge badge-<?= ($n->nilai >= 75) ? 'success' : 'danger' ?> p-2 px-3">
                                                                <?= $n->nilai ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="<?= site_url('admin/update_nilai/' . $n->id) ?>"
                                                                class="btn btn-info btn-sm">Edit ✎</a>
                                                            <a href="<?= site_url('admin/delete_nilai/' . $n->id) ?>"
    ...
    <?php if ($this->session->flashdata('success-reg')): ?>
        <script>Swal.fire({ icon: 'success', title: 'Nilai Ditambahkan!', showConfirmButton: false, timer: 2500 })</script>
    <?php endif; ?>
    <?php if ($this->session->flashdata('success-edit')): ?>
        <script>Swal.fire({ icon: 'success', title: 'Nilai Diperbarui!', showConfirmButton: false, timer: 2500 })</script>
    <?php endif; ?>
    <?php if ($this->session->flashdata('user-delete')): ?>
        <script>Swal.fire({ icon: 'success', title: 'Nilai Dihapus!', showConfirmButton: false, timer: 2500 })</script>
    <?php endif; ?>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.remove', function (e) {
                ...
                Swal.fire({
                    ...
                    text: 'Data nilai akan terhapus permanen!',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#d33',
                    cancelButtonColor: '#3085d6',
                    confirmButtonText: 'Ya, Hapus!'
                }).then((r) => { if (r.value) { window.location.href = url; } });
            });
        });
    </script>
