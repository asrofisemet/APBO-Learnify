            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            echo isset($data['user']['username']) ? $data['user']['username'] : 'Admin';
                            ?></div>
                        </a>
                ...
                <section class="section">
                    <div class="">
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class="col-md-4 mx-auto rounded-circle bg-white p-3"
                                ...
                                <img src="<?= base_url('assets/') ?>Bob.jpg"
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Bob Gallagher's</h2>
                                <hr>
                                <p class="card-text">Perfectionist Web Developer with one years of experience as a Web
                                    Developer and Web Designer. Skilled at Designing and developing Websites. Excellent
                                    written and oral communication skills; capable of explaining complex software issues
                                    in easy-to-understand terms. </p>
                            </div>
                        </div>
                    </div>
                    <br>
