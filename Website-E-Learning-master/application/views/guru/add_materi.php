                        ...
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true"
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="<?=base_url('guru/add_materi')?>"
                            ...
                            <li class="kt-menu__item" aria-haspopup="true"><a
                                    href="<?=base_url('guru/data_nilai')?>" class="kt-menu__link"><i
                                        class="kt-menu__link-icon flaticon2-checking"></i><span
                                        class="kt-menu__link-text">Data Nilai</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
